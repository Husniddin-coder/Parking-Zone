...
namespace Parking_Zone.Data.Migrations
{
    ...
    [Migration("20240507102824_NewReservation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Parking_Zone.Data.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Parking_Zone.Domain.Entities.Reservation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Parking_Zone.Data.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Parking_Zone.Domain.Entities.Reservation", b =>
                {
                    ...
                    b.HasOne("Parking_Zone.Domain.Entities.ParkingSlot", "ParkingSlot")
                        .WithMany("Reservations")
